...
Funcionalidade: Cadastro de filmes
    ...
    Esquema do Cenario: Novo filme
        O gestor de catálogo cadastra um novo filme atravpes do formulário
    ...
    Cenario: Duplicado
        ...
        já foi cadastrado em um outro momento, e o sistema notifica
        o usuário informando que já existe
